...
public class ItemController {
    ...
    @Operation(
            summary = "Создание нового товара", description = "Позволяет создать новый товар с указанными параметрами"
    )
    @ApiResponses(value = {
    ...
    public ResponseEntity<ItemDTO> createItem(
            @Valid @RequestBody
            @Parameter(description = "Данные для создания товара", required = true, schema = @Schema(implementation = CreateItemDTO.class))
        ...
        logger.info("Товар успешно создан. Артикул: {}", createdItem.article());
        return ResponseEntity.ok(createdItem);
    }

    @Operation(
            summary = "Получение информации о товаре", description = "Возвращает информацию о товаре по его артикулу"
    )
    @ApiResponses(value = {
    ...
    public ResponseEntity<ItemDTO> getItem(
        ...
        logger.debug("Запрос на получение товара. Артикул: {}", article);
        ItemDTO item = itemService.getItem(article)
                .orElseThrow(() -> {
                    logger.warn("Товар не найден. Артикул: {}", article);
                    return new ItemNotFoundException("Товар с артикулом " + article + " не найден");
                });

        logger.debug("Товар найден. Артикул: {}", article);
        return ResponseEntity.ok(item);
    }

    @Operation(
            summary = "Обновление информации о товаре", description = "Позволяет обновить информацию о существующем товаре"
    )
    @ApiResponses(value = {
    ...
    public ResponseEntity<ItemDTO> updateItem(
            @Valid @RequestBody
            @Parameter(description = "Данные для обновления товара", required = true, schema = @Schema(implementation = UpdateItemDTO.class))
            UpdateItemDTO updateItemDTO) {

        logger.info("Запрос на обновление товара. Артикул: {}", updateItemDTO.article());
        ItemDTO updatedItem = itemService.updateItem(updateItemDTO);
        logger.info("Товар успешно обновлен. Артикул: {}", updatedItem.article());
        return ResponseEntity.ok(updatedItem);
    }

    @Operation(
            summary = "Удаление товара", description = "Удаляет товар по указанному артикулу"
    )
    @ApiResponses(value = {
    ...
    public ResponseEntity<Void> deleteItem(
        ...
        logger.info("Запрос на удаление товара. Артикул: {}", article);
        itemService.deleteItem(article);
        logger.info("Товар успешно удален. Артикул: {}", article);
